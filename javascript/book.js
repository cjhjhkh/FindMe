...
window.addEventListener('load', () => {
    ...
    axios({
        ...
        nowMe.src = `${preMe}`;//现在的我的画板
        futureMe.src = `${postMe}`;//将来的我的画板
        ...
        jobName1[0].innerHTML = myJobList[0].jobName;
        jobName1[1].innerHTML = myJobList[1].jobName;
        jobName2[0].innerHTML = myJobList[2].jobName;
        jobName2[1].innerHTML = myJobList[3].jobName;
        ...
        const jobAva1 = document.querySelectorAll('.page6 .sticker-area');
        const jobAva2 = document.querySelectorAll('.page7 .sticker-area');
        // for(let i = 0;i<4;i++){
        // alert(2)
        jobAva1[0].style.backgroundImage = `url(./images/${myJobList[0].picture})`;
        jobAva1[1].style.backgroundImage = `url(./images/${myJobList[1].picture})`;
        jobAva2[0].style.backgroundImage = `url(./images/${myJobList[2].picture})`;
        jobAva2[1].style.backgroundImage = `url(./images/${myJobList[3].picture})`;
        // }
